  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-dark px-5 text-dark-text">
      <section className="w-full max-w-md rounded-xl border border-dark-line bg-dark-card p-8 text-center sm:p-10">
        ...
        <p className="mt-10 font-mono text-xs uppercase tracking-[0.18em] text-dark-dim">404 · page not found</p>
        <h1 className="mt-3 text-3xl font-semibold tracking-tight">This page is not in the catalogue.</h1>
        <p className="mt-3 text-sm leading-6 text-dark-muted">The address may be outdated, or the page may have moved.</p>
